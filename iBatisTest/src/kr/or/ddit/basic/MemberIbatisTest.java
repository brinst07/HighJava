...
public class MemberIbatisTest {
	public static void main(String[] args) {
		...
		try {
			...
			//형식) smc.inser("namespace값.id값", 파라미터클래스);
			// 				반환값 : 성공하면 null이 반환된다.
			...
			int cnt = smc.update("memberTest.updateMember",mv2); //네임스페이스.updateMember
			if(cnt > 0) {
			...
			*/
			...
			MemberVO mv4 = (MemberVO) smc.queryForObject("memberTest.getMember","A003");
